...
if __name__ == '__main__':
    ...
    for step in range(args.P_num):
        # FIX 1: reset gradient accumulation at the start of each step
        # Bug: sample_total_g and sample_step_count were never reset, causing
        # step k's update to be diluted by all (k+1)*N_frames previous gradients.
        # With 10 steps x 1500 frames, step 9's avg_gradient was 1/15000 of cumulative sum.
        sample_step_count = 0
    ...
    uap_save_path = f"uap_file/{args.train_dataset}_fixed.pth"
